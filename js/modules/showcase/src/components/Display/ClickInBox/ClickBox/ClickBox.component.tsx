...
const ClickBox: React.FC = () => {
    ...
    // To show instructional div only if the user hasn't used the element yet
    ...
    const activateAnimation: React.MouseEventHandler<HTMLDivElement> = (e) => {
        // We are getting the position of the click then finding out the offet
    ...
    // Because the last click may play backwards, which is pleasant UX
    ...
    return (
        <div
            ...
            style={{
                ...
                opacity: clickBoxCtx.parentOpacity,
            }}
